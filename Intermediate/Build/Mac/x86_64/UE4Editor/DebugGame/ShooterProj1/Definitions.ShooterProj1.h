...
#define UE_PROJECT_NAME ShooterProj1
#define UE_TARGET_NAME ShooterProj1Editor
#define UE_MODULE_NAME "ShooterProj1"
...
#define SHOOTERPROJ1_API DLLEXPORT
