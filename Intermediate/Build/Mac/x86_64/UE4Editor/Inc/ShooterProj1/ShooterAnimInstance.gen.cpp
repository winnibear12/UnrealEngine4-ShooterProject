...
#include "ShooterProj1/ShooterAnimInstance.h"
...
// Cross Module References
	SHOOTERPROJ1_API UClass* Z_Construct_UClass_UShooterAnimInstance_NoRegister();
	SHOOTERPROJ1_API UClass* Z_Construct_UClass_UShooterAnimInstance();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UShooterAnimInstance_Statics::NewProp_bIsInAir_MetaData[] = {
		{ "AllowPrivateAccess", "ture" },
		{ "Category", "Movement" },
		{ "Comment", "//check if the character is in the air\n" },
		{ "ModuleRelativePath", "ShooterAnimInstance.h" },
		{ "ToolTip", "check if the character is in the air" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UShooterAnimInstance_Statics::NewProp_bIsAccelerating_MetaData[] = {
		{ "AllowPrivateAccess", "ture" },
		{ "Category", "Movement" },
		{ "Comment", "//check if the character is moving\x09\n" },
		{ "ModuleRelativePath", "ShooterAnimInstance.h" },
		{ "ToolTip", "check if the character is moving" },
	};
#endif
	...
	IMPLEMENT_CLASS(UShooterAnimInstance, 1254786599);
	template<> SHOOTERPROJ1_API UClass* StaticClass<UShooterAnimInstance>()
	{
		return UShooterAnimInstance::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UShooterAnimInstance(Z_Construct_UClass_UShooterAnimInstance, &UShooterAnimInstance::StaticClass, TEXT("/Script/ShooterProj1"), TEXT("UShooterAnimInstance"), false, nullptr, nullptr, nullptr);
