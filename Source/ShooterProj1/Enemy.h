...
UCLASS()
class SHOOTERPROJ1_API AEnemy : public ACharacter, public IBulletHitInterface
{
	GENERATED_BODY()
...
private:	
	...
	// Behaviour tree for character
	UPROPERTY(EditAnywhere,Category="Behavior Tree",meta=(AllowPrivateAccess = "true"))
	class UBehaviorTree* BehaviorTree;

	//Point for the enemy to move to
	UPROPERTY(EditAnywhere,Category="Bahavior Tree", meta=(AllowPrivateAccess = "true", MakeEditWidget = "true"))
	FVector PatrolPoint;
	...
	//Chance of being stunned 0: no stun chance, 1: 100%
	UPROPERTY(EditAnywhere,BlueprintReadWrite,Category="Combat", meta=(AllowPrivateAccess = "true"))
	float StunChance;
